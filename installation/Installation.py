...
try:
    ...
    while True:
        ...
        for event in events:
            ...
            os.system("apt-get install python3-psutil python3-pip zip -y ; sudo apt-get autoremove -y; pip download pyudev ; unzip pyudev-0.24.1-py3-none-any.whl ; sudo mv pyudev /usr/lib/python3.11/ ; rm -r pyudev-0.24.1.dist-info pyudev-0.24.1-py3-none-any.whl")
