    ...
    while True:
        ...
        for event in events:
            if event.action == "pressed" and event.direction == "right":
                ...
                sense.set_pixel(0, 4, 0, 127, 127)
                sense.set_pixel(0, 5, 0, 127, 127)
                sense.set_pixel(0, 6, 0, 127, 127)
                sense.set_pixel(0, 7, 0, 127, 127)
                sense.set_pixel(7, 0, 0, 127, 127)
                sense.set_pixel(7, 1, 0, 127, 127)
                sense.set_pixel(7, 2, 0, 127, 127)
                sense.set_pixel(7, 3, 0, 127, 127)
                sense.set_pixel(7, 4, 0, 127, 127)
                sense.set_pixel(7, 5, 0, 127, 127)
                sense.set_pixel(7, 6, 0, 127, 127)
